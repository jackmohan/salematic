...
(function() {
    ...
    function Va(g, l, v) {
        "millisecond" === v ? g.setMilliseconds(g.getMilliseconds() + 1 * l) : "second" === v ? g.setSeconds(g.getSeconds() + 1 * l) : "minute" === v ? g.setMinutes(g.getMinutes() + 1 * l) : "hour" === v ? g.setHours(g.getHours() + 1 * l) : "day" === v ? g.setDate(g.getDate() + 1 * l) : "week" === v ? g.setDate(g.getDate() + 7 * l) : "month" === v ? g.setMonth(g.getMonth() + 1 * l) : "year" === v && g.setFullYear(g.getFullYear() + 1 * l);
        return g
    }
    ...
    function gb(g) {
        if (g._menuButton) g.exportEnabled ? (ga(g._menuButton, {
            ...
            J(g._menuButton, "click", function() {
                "none" !== g._dropdownMenu.style.display || g._dropDownCloseTime && 500 >= (new Date).getTime() - g._dropDownCloseTime.getTime() || (g._dropdownMenu.style.display = "block", g._menuButton.blur(), g._dropdownMenu.focus())
            ...
            J(g._menuButton, "mouseout", function() {
                l || (ga(g._menuButton, {
                    backgroundColor: g.toolbar.itemBackgroundColor,
                    color: g.toolbar.fontColor
                }), 0 >= navigator.userAgent.search("MSIE") && ga(g._menuButton.childNodes[0], {
        ...
        if (g.exportEnabled && g._dropdownMenu) {
        ...
        }, g.allDOMEventHandlers, !0), v = document.createElement("div"), v.style.cssText = "padding: 12px 8px 12px 8px", v.innerHTML = g._cultureInfo.printText, v.style.backgroundColor = g.toolbar.itemBackgroundColor, v.style.color = g.toolbar.fontColor, g._dropdownMenu.appendChild(v), J(v, "touchstart", function(g) {
            l = !0
            ...
            g.print();
            ua(g._dropdownMenu)
        }, g.allDOMEventHandlers, !0), v = document.createElement("div"), v.style.cssText = "padding: 12px 8px 12px 8px", v.innerHTML = g._cultureInfo.saveJPGText, v.style.backgroundColor = g.toolbar.itemBackgroundColor, v.style.color = g.toolbar.fontColor, g._dropdownMenu.appendChild(v), J(v, "touchstart", function(g) {
            l = !0
        }, g.allDOMEventHandlers), J(v, "mouseover", function() {
            l || (this.style.backgroundColor = g.toolbar.itemBackgroundColorOnHover, this.style.color = g.toolbar.fontColorOnHover)
        }, g.allDOMEventHandlers, !0), J(v, "mouseout", function() {
    ...
    function va(g, l, v) {
        ...
        l.getAttribute("state") !== v && (l.setAttribute("state", v), l.setAttribute("type", "button"), ga(l, {
            padding: "5px 12px",
            cursor: "pointer",
            "float": "left",
            width: "40px",
    ...
    var fb = function() {
        ...
        ea = function(g, l, v) {
            ...
            else "E" !== l[0] && "e" !== l[0] || "0" !== l[l.length - 1] || !/[eE][+-]*[0]+/.test(l) ? "," === l ? (K++, F = S, S = 0, 0 < E.length && (v = y + v)) : v = 1 < l.length && ('"' === l[0] && '"' === l[l.length - 1] || "'" === l[0] && "'" === l[l.length - 1]) ? l.slice(1, l.length - 1) + v : l + v : (l = 0 > U ? l.replace("+", "").replace("-", "") : l.replace("-", ""), v += l.replace(/[0]+/, function(a) {
                return X(U, a.length)
            }));
            y = "";
        ...
        ca = function(g, l, v, s, w, y, E, F, N, M, P, S, H) {
            ...
            !0 === M && (g.save(), g.beginPath(), g.moveTo(l, w), g.lineTo(l + J, w - J), g.lineTo(s - J, w - J), g.lineTo(s, w), g.closePath(), E = g.createLinearGradient((s + l) / 2, w - J, (s + l) / 2, w), E.addColorStop(0, y), E.addColorStop(1, "rgba(255, 255, 255, .4)"), g.fillStyle = E, g.fill(), g.restore());
            ...
            !0 === S && (g.save(), g.beginPath(), g.moveTo(s, v), g.lineTo(s - J, v + J), g.lineTo(s - J, w - J), g.lineTo(s, w), E = g.createLinearGradient(s - J, (w + v) / 2, s, (w + v) / 2), E.addColorStop(0, y), E.addColorStop(1, "rgba(255, 255, 255, 0.1)"), g.fillStyle = E, E.addColorStop(0, y), E.addColorStop(1, "rgba(255, 255, 255, 0.1)"), g.fillStyle = E, g.fill(), g.closePath(), g.restore())
        },
        W = function(g) {
            for (var l = "", s = 0; s < g.length; s++) l += String.fromCharCode(Math.ceil(g.length / 57 / 5) ^ g.charCodeAt(s));
            return l
        },
        bb = window && window[W("mnb`uhno")] && window[W("mnb`uhno")].href && window[W("mnb`uhno")].href.indexOf && (-1 !== window[W("mnb`uhno")].href.indexOf(W("b`ow`rkr/bnl")) || -1 !== window[W("mnb`uhno")].href.indexOf(W("gdonqhy/bnl")) || -1 !== window[W("mnb`uhno")].href.indexOf(W("gheemd"))),
    ...
    U.prototype.set = function(g, l, s) {
        ...
        if ("options" === g) this.createUserOptions(l);
            ...
            window.console && (w.publicProperties && w.publicProperties.hasOwnProperty(g) && "readOnly" === w.publicProperties[g] ? window.console.log('Property "' + g + '" is read-only.') : window.console.log('Property "' + g + "\" doesn't exist. Please check for typo."));
            return
        }
    ...
    U.prototype.createUserOptions = function(g) {
        if ("undefined" !== typeof g || this.options._isPlaceholder)
            if (this.parent.options._isPlaceholder && this.parent.createUserOptions(), this.isOptionsInArray) {
                ...
                l[s] = this.options
            } else this.options = "undefined" === typeof g ? {} : g, g = this.parent.options, this.optionsName ? l = this.optionsName : (l = this._defaultsKey) && 0 !== l.length ? (s = l.charAt(0).toLowerCase(), 1 < l.length && (s = s.concat(l.slice(1))), l = s) : l = void 0, g[l] = this.options
    };
    ...
    U.prototype.addEventListener = function(g, l, s) {
        g && l && (this._eventListeners[g] = this._eventListeners[g] || [], this._eventListeners[g].push({
            context: s || this,
            eventHandler: l
        }))
    };
    ...
    ya.prototype.setLayout = function() {
        if (this.text) {
            ...
            var M;
            s(this.padding) || "number" !== typeof this.padding ? s(this.padding) || "object" !== typeof this.padding || (M = this.padding.top ? this.padding.top : this.padding.bottom ? this.padding.bottom : 0, M += this.padding.bottom ? this.padding.bottom : this.padding.top ? this.padding.top : 0) : M = 2 * this.padding;
    ...
    "undefined" !== typeof module && "undefined" !== typeof module.exports ? module.exports = Oa : "function" === typeof define && define.amd ? define([], function() {
        return Oa
    ...
    y = Oa.Chart = function() {
        ...
        function v(a, d) {
            for (var c = [], b, e = 0; e < a.length; e++)
                if (0 == e) c.push(a[0]);
                    ...
                    b = Math.abs((a[p].x - a[f].x) / (0 === a[p].x - a[t].x ? 0.01 : a[p].x - a[t].x)) * (d - 1) / 2 + 1;
                    var B = (a[p].x - a[f].x) / b;
                    b = (a[p].y - a[f].y) / b;
        ...
        function y(a, d, c, b, e, f, p, t, B, k) {
            ...
            a.beginPath();
            B && 0 < t.thickness ? (a.moveTo(b - p.thickness / 2, Math.round((c + e) / 2) - n), a.lineTo(d + p.thickness / 2, Math.round((c + e) / 2) - n)) : 0 < t.thickness && (a.moveTo(Math.round((d + b) / 2) - n, c + p.thickness / 2), a.lineTo(Math.round((d + b) / 2) - n, e - p.thickness / 2));
            a.stroke();
                    ...
                    if (!this.data[d].axisYType || "primary" === this.data[d].axisYType)
                        if (this.options.axisY && 0 < this.options.axisY.length) {
                            if (!this.axisY.length)
                                for (var c = 0; c < this.options.axisY.length; c++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY[c] = new E(this, "axisY", this.options.axisY[c], c, "axisY", "left")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY[c] = new E(this, "axisY", this.options.axisY[c], c, "axisY", "bottom"));
                    ...
                    if ("secondary" === this.data[d].axisYType)
                        if (this.options.axisY2 && 0 < this.options.axisY2.length) {
                            if (!this.axisY2.length)
                                for (c = 0; c < this.options.axisY2.length; c++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisY2[c] = new E(this, "axisY2", this.options.axisY2[c], c, "axisY", "right")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisY2[c] = new E(this, "axisY2", this.options.axisY2[c], c, "axisY", "top"));
                    ...
                    if (!this.data[d].axisXType || "primary" === this.data[d].axisXType)
                        if (this.options.axisX && 0 < this.options.axisX.length) {
                            if (!this.axisX.length)
                                for (c = 0; c < this.options.axisX.length; c++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX[c] = new E(this, "axisX", this.options.axisX[c], c, "axisX", "bottom")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX[c] = new E(this, "axisX", this.options.axisX[c], c, "axisX", "left"));
                    ...
                    if ("secondary" === this.data[d].axisXType)
                        if (this.options.axisX2 && 0 < this.options.axisX2.length) {
                            if (!this.axisX2.length)
                                for (c = 0; c < this.options.axisX2.length; c++) "normal" === this.plotInfo.axisPlacement ? this._axes.push(this.axisX2[c] = new E(this, "axisX2", this.options.axisX2[c], c, "axisX", "top")) : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push(this.axisX2[c] = new E(this, "axisX2", this.options.axisX2[c], c, "axisX", "right"));
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = !1, t = !1, B = [], k = 0; k < a.dataSeriesIndexes.length; k++) {
                    var m = this.data[a.dataSeriesIndexes[k]],
                        ...
                        h = !1,
                        r;
                    if ("normal" === m.axisPlacement || "xySwapped" === m.axisPlacement) var g = a.axisX.sessionVariables.newViewportMinimum ? a.axisX.sessionVariables.newViewportMinimum : this.options.axisX && this.options.axisX.viewportMinimum ? this.options.axisX.viewportMinimum : this.options.axisX && this.options.axisX.minimum ? this.options.axisX.minimum : -Infinity,
                    ...
                    for (n = 0; n < m.dataPoints.length; n++) {
                        ...
                        if (0 < n) {
                            ...
                            } else u = b - m.dataPoints[n - 1].x, 0 > u && (u *= -1), c.minDiff > u && 0 !== u && (c.minDiff = u);
                        ...
                        if (b < g && !q) null !== e && (r = b);
                            ...
                            b < c.viewPortMin && (c.viewPortMin = b);
                            b > c.viewPortMax && (c.viewPortMax = b);
                            null === e ? c.viewPortMin === b && r < b && (c.viewPortMin = r) : (a.yTotals[b] = (a.yTotals[b] ? a.yTotals[b] : 0) + e, a.yAbsTotals[b] = (a.yAbsTotals[b] ? a.yAbsTotals[b] : 0) + Math.abs(e), 0 <= e ? p = !0 : 0 > e && (t = !0), B[b] = B[b] ? B[b] + Math.abs(e) : Math.abs(e))
                        }
                    }
        ...
        l.prototype._processSpecificPlotUnit = function(a) {
            if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    for (B = 0; B < t.dataPoints.length; B++)
                        if ("undefined" === typeof t.dataPoints[B].x && (t.dataPoints[B].x = B + (a.axisX.logarithmic ? 1 : 0)), t.dataPoints[B].x.getTime ? (f = !0, b = t.dataPoints[B].x.getTime()) : b = t.dataPoints[B].x, e = t.dataPoints[B].y, b < c.min && (c.min = b), b > c.max && (c.max = b), t.dataPointEOs[B].cumulativeSum < d.min && (d.min = t.dataPointEOs[B].cumulativeSum), t.dataPointEOs[B].cumulativeSum > d.max && (d.max = t.dataPointEOs[B].cumulativeSum), 0 < B && (a.axisX.logarithmic ? (n = b / t.dataPoints[B - 1].x, 1 > n && (n = 1 / n), c.minDiff > n && 1 !== n && (c.minDiff = n)) : (n = b - t.dataPoints[B - 1].x, 0 > n && (n *= -1), c.minDiff > n && 0 !== n && (c.minDiff = n)), null !== e && null !== t.dataPoints[B - 1].y && (a.axisY.logarithmic ? (e = t.dataPointEOs[B].cumulativeSum / t.dataPointEOs[B - 1].cumulativeSum, 1 > e && (e = 1 / e), d.minDiff > e && 1 !== e && (d.minDiff = e)) : (e = t.dataPointEOs[B].cumulativeSum - t.dataPointEOs[B - 1].cumulativeSum, 0 > e && (e *= -1), d.minDiff > e && 0 !== e && (d.minDiff = e)))), !(b < q) || k) {
                            if (!k && (k = !0, 0 < B)) {
                                B -= 2;
                                continue
                            }
        ...
        l.prototype.calculateAutoBreaks = function() {
            ...
            for (var b, e = this, f = !1, p = 0; p < this._axes.length; p++)
                ...
                for (p = 0; p < this.plotInfo.plotTypes.length; p++)
                    for (f = this.plotInfo.plotTypes[p], t = 0; t < f.plotUnits.length; t++) b = f.plotUnits[t], "line" === b.type || "stepLine" === b.type || "spline" === b.type || "column" === b.type || "area" === b.type || "stepArea" === b.type || "splineArea" === b.type || "bar" === b.type || "bubble" === b.type || "scatter" === b.type || "candlestick" === b.type || "ohlc" === b.type || "rangeColumn" === b.type || "rangeBar" === b.type || "rangeArea" === b.type || "rangeSplineArea" === b.type || "waterfall" === b.type || "error" === b.type || "boxAndWhisker" === b.type ? d(b) : 0 <= b.type.indexOf("stacked") && c(b);
                        ...
                        if (this._axes[p].scaleBreaks.customBreaks)
                            for (t = 0; t < this._axes[p].scaleBreaks.customBreaks.length; t++)
                                for (b = 0; b < f.length; b++)
                                    if (this._axes[p].scaleBreaks.customBreaks[t].startValue <= f[b].start && f[b].start <= this._axes[p].scaleBreaks.customBreaks[t].endValue || this._axes[p].scaleBreaks.customBreaks[t].startValue <= f[b].start && f[b].start <= this._axes[p].scaleBreaks.customBreaks[t].endValue || f[b].start <= this._axes[p].scaleBreaks.customBreaks[t].startValue && this._axes[p].scaleBreaks.customBreaks[t].startValue <= f[b].end || f[b].start <= this._axes[p].scaleBreaks.customBreaks[t].endValue && this._axes[p].scaleBreaks.customBreaks[t].endValue <= f[b].end) f.splice(b, 1), b--;
                        f.sort(function(a, b) {
        ...
        l.prototype.validateRegion = function(a, d, c, b, e) {
            ...
            for (p = 0; p < k.length; p++) {
                ...
                if (isFinite(n.dataInfo.minDiff))
                    if (r = n.getApparentDifference(q, h, null, !0), !(f || !(this.panEnabled && n.scaleBreaks && n.scaleBreaks._appliedBreaks.length) && (n.logarithmic && r < Math.pow(n.dataInfo.minDiff, 3) || !n.logarithmic && r < 3 * Math.abs(n.dataInfo.minDiff)) || q < n.minimum || h > n.maximum)) B.push(n), m.push({
                        val1: q,
                        val2: h
                    }), t = !0;
                    else if (!e) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                if (null !== D && "" !== D) {
                    ...
                    if ("normal" === this.plotInfo.axisPlacement) {
                        ...
                        "inside" !== A ? (e = c.y1, f = c.y2, 0 < v ? (h = m.point.y + ("horizontal" === C ? r / 2 : 0) - k - t - b, h < e && (h = "auto" === A ? Math.max(m.point.y, e) + r / 2 + t : e + r / 2 + t, y = h + k > m.point.y)) : (h = m.point.y + r / 2 + t + b, h > f - k && (h = "auto" === A ? Math.min(m.point.y, f) + r / 2 - k - t : f + r / 2 - k, y = h < m.point.y))) : (e = Math.max(m.bounds.y1, c.y1), f = Math.min(m.bounds.y2, c.y2 - k + r / 2), b = 0 <= n.indexOf("range") || "error" === n ? 0 < v ? Math.max(m.bounds.y1, c.y1) + r / 2 + t : Math.min(m.bounds.y2, c.y2) + r / 2 - k + t : (Math.max(m.bounds.y1, c.y1) + Math.min(m.bounds.y2, c.y2)) / 2 - k / 2 + r / 2 + ("horizontal" === C ? t : 0), 0 < v ? (h = Math.max(m.point.y, b), h < e && ("bubble" === n || "scatter" === n) && (h = Math.max(m.point.y - k - t, c.y1 + t))) : (h = Math.min(m.point.y, b), h > f - k - t && ("bubble" === n || "scatter" === n) && (h = Math.min(m.point.y + t, c.y2 - k - t))), h = Math.min(h, f))
                    } else 0 <= n.indexOf("line") || 0 <= n.indexOf("area") || 0 <= n.indexOf("scatter") ? (A = "auto", p = 4) : 0 <= n.indexOf("stacked") ? "auto" === A && (A = "inside") : "bubble" === n && (A = "inside"), h = m.point.y + r / 2 - k / 2 + t, "inside" !== A ? (e = c.x1, f = c.x2, 0 > v ? (q = m.point.x - ("horizontal" === C ? B : B - r / 2) - p - b, q < e && (q = "auto" === A ? Math.max(m.point.x, e) + p : e + p, y = q + B > m.point.x)) : (q = m.point.x + ("horizontal" === C ? 0 : r / 2) + p + b, q > f - B - p - b && (q = "auto" === A ? Math.min(m.point.x, f) - ("horizontal" === C ? B : B / 2) - p : f - B - p, y = q < m.point.x))) : (e = Math.max(m.bounds.x1, c.x1), Math.min(m.bounds.x2, c.x2), b = 0 <= n.indexOf("range") || "error" === n ? 0 > v ? Math.max(m.bounds.x1, c.x1) + r / 2 + p : Math.min(m.bounds.x2, c.x2) - B / 2 - p + ("horizontal" === C ? 0 : r / 2) : (Math.max(m.bounds.x1, c.x1) + Math.min(m.bounds.x2, c.x2)) / 2 + ("horizontal" === C ? 0 : r / 2), q = 0 > v ? Math.max(m.point.x, b) - ("horizontal" === C ? B / 2 : 0) : Math.min(m.point.x, b) - B / 2, q = Math.max(q, e));
                    "vertical" === C && (h += k - r / 2);
                    g.x = q;
                    g.y = h;
                    g.render(!0);
                    x && ("inside" !== A && (0 > n.indexOf("bar") && ("error" !== n || !m.axisSwapped) && m.point.x > c.x1 && m.point.x < c.x2 || !y) && (0 > n.indexOf("column") && ("error" !== n || m.axisSwapped) && m.point.y > c.y1 && m.point.y < c.y2 || !y)) && (d.lineWidth = x, d.strokeStyle = u ? u : "gray", d.setLineDash && d.setLineDash(N(l, x)), d.beginPath(), d.moveTo(m.point.x, m.point.y), 0 <= n.indexOf("bar") || "error" === n && m.axisSwapped ? d.lineTo(q + (0 < m.direction ? -p : B + p) + ("vertical" === C ? -r / 2 : 0), h + ("vertical" === C ? -k / 2 : k / 2 - r / 2) - t) : 0 <= n.indexOf("column") || "error" === n && !m.axisSwapped ? d.lineTo(q + B / 2 - ("horizontal" === C ? 0 : r / 2), h + ("vertical" === C ? (h - k < m.point.y ? 0 : -k) + t : (h - r / 2 < m.point.y ? k : 0) - r / 2)) : d.lineTo(q + B / 2 - ("horizontal" === C ? 0 : r / 2), h + ("vertical" === C ? h - k < m.point.y ? 0 : -k : (h - r / 2 < m.point.y ? k : 0) - r / 2)), d.stroke())
                }
            }
            d = {
                source: d,
                        ...
                        for (var C = !1, u = 0; u < m.length; u++)
                            if (x = m[u].x.getTime ? m[u].x.getTime() : m[u].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !C)))
                                if ("number" !== typeof m[u].y) 0 < u && !(k.connectNullData || C || l) && (c.stroke(), w && b.stroke()), C = !0;
                                    ...
                                    l || C ? (!l && k.connectNullData ? (c.setLineDash && (k.options.nullDataLineDashType || n === k.lineDashType && k.lineDashType !== k.nullDataLineDashType) && (c.stroke(), c.beginPath(), c.moveTo(p.x, p.y), n = k.nullDataLineDashType, c.setLineDash(q)), c.lineTo(x, s), w && b.lineTo(x, s)) : (c.beginPath(), c.moveTo(x, s), w && (b.beginPath(), b.moveTo(x, s))), C = l = !1) : (c.lineTo(x, s), w && b.lineTo(x, s), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(x, s), w && (b.stroke(), b.beginPath(), b.moveTo(x, s))));
                                    p = {
                                        x: x,
                                        y: s
                                    };
                                    u < m.length - 1 && (g !== (m[u].lineColor || r) || n !== (m[u].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(x, s), g = m[u].lineColor || r, c.strokeStyle = g, c.setLineDash && (m[u].lineDashType ? (n = m[u].lineDashType, c.setLineDash(N(n, k.lineThickness))) : (n = k.lineDashType, c.setLineDash(h))));
                        ...
                        for (var C = !1, u = 0; u < m.length; u++)
                            if (x = m[u].getTime ? m[u].x.getTime() : m[u].x, !(x < a.axisX.dataInfo.viewPortMin || x > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !C)))
                                if ("number" !== typeof m[u].y) 0 < u && !(k.connectNullData || C || l) && (c.stroke(), w && b.stroke()), C = !0;
                                    ...
                                    u < m.length - 1 && (g !== (m[u].lineColor || r) || n !== (m[u].lineDashType || k.lineDashType)) && (c.stroke(), c.beginPath(), c.moveTo(x, s), g = m[u].lineColor || r, c.strokeStyle = g, c.setLineDash && (m[u].lineDashType ? (n = m[u].lineDashType, c.setLineDash(N(n, k.lineThickness))) : (n = k.lineDashType, c.setLineDash(h))));
                                    if (0 < m[u].markerSize || 0 < k.markerSize) D = k.getMarkerProperties(u, x, s, c), f.push(D), z = P(z), w && f.push({
                                        x: x,
                                        y: s,
                                        ctx: b,
                                        type: D.type,
                    ...
                    if (0 < m.length)
                        for (x = !1, l = 0; l < m.length; l++)
                            if (u = m[l].getTime ? m[l].x.getTime() : m[l].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !x)))
                                if ("number" !== typeof m[l].y) 0 < l && !x && (k.connectNullData ? b.setLineDash && (0 < s.length && (k.options.nullDataLineDashType || !m[l - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = q, n = k.nullDataLineDashType) : (d(s), s = [])), x = !0;
                                else {
                                    ...
                                    l < m.length - 1 && (g !== (m[l].lineColor || r) || n !== (m[l].lineDashType || k.lineDashType)) && (g = m[l].lineColor || r, s[s.length - 1].newStrokeStyle = g, b.setLineDash && (m[l].lineDashType ? (n = m[l].lineDashType, s[s.length - 1].newLineDashArray = N(n, k.lineThickness)) : (n = k.lineDashType, s[s.length - 1].newLineDashArray = h)));
                        ...
                        for (k = 0; k < u.length; k++)
                            if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                ...
                                var s = m - a.plotType.plotUnits.length * h / 2 + a.index * h << 0,
                                    C = s + h << 0,
                                    D;
                                if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y) t[b] = u[k].y + (t[b] ? t[b] : 0), 0 < t[b] && (n = a.axisY.convertValueToPixel(t[b]), D = "undefined" !== typeof f[b] ? f[b] : q, f[b] = n);
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                ...
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) B[b] = u[k].y + (B[b] ? B[b] : 0), m = p[b] ? p[b] : q, p[b] = D = a.axisY.convertValueToPixel(B[b]);
                                ...
                                b = P(b);
                                w && ca(this._eventManager.ghostCtx, D, s, m, C, b, 0, null, !1, !1, !1, !1);
                                (u[k].indexLabel || l.indexLabel || u[k].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (b = u[k].x.getTime ? u[k].x.getTime() : u[k].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y) {
                                ...
                                } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) B[b] = A + (B[b] ? B[b] : 0), m = p[b] ? p[b] : q, p[b] = A = a.axisY.convertValueToPixel(B[b]);
                        ...
                        for (var ja = !0; g < r.length; g++)
                            if (s = r[g].x.getTime ? r[g].x.getTime() : r[g].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !ja)))
                                if ("number" !== typeof r[g].y) h.connectNullData || (ja || d) || b(), ja = !0;
                                    ...
                                    d || ja ? (!d && h.connectNullData ? (f.setLineDash && (h.options.nullDataLineDashType || c === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (d = l, c = u, l = m.x, u = m.y, b(), f.moveTo(m.x, m.y), l = d, u = c, D = m, c = h.nullDataLineDashType, f.setLineDash(Q)), f.lineTo(l, u), w && p.lineTo(l, u)) : (f.beginPath(), f.moveTo(l, u), w && (p.beginPath(), p.moveTo(l, u)), D = {
                                        x: l,
                                        y: u
                                    }), ja = d = !1) : (f.lineTo(l, u), w && p.lineTo(l, u), 0 == g % 250 && b());
                                    m = {
                                        x: l,
                                        y: u
                                    };
                    ...
                    if (0 < n.length) {
                        ...
                        for (r = !1; q < n.length; q++)
                            if (h = n[q].x.getTime ? n[q].x.getTime() : n[q].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !r)))
                                if ("number" !== typeof n[q].y) 0 < q && !r && (m.connectNullData ? b.setLineDash && (0 < s.length && (m.options.nullDataLineDashType || !n[q - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = y, z = m.nullDataLineDashType) : (d(), s = [])), r = !0;
                                else {
                                    ...
                                    q < n.length - 1 && (D !== (n[q].lineColor || C) || z !== (n[q].lineDashType || m.lineDashType)) && (D = n[q].lineColor || C, s[s.length - 1].newStrokeStyle = D, b.setLineDash && (n[q].lineDashType ? (z = n[q].lineDashType, s[s.length - 1].newLineDashArray = N(z, m.lineThickness)) : (z = m.lineDashType, s[s.length - 1].newLineDashArray = E)));
                    ...
                    if (0 < r.length) {
                        ...
                        for (; g < r.length; g++)
                            if (s = r[g].x.getTime ? r[g].x.getTime() : r[g].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !c))) {
                                var Y = u;
                                "number" !== typeof r[g].y ? (h.connectNullData || (c || d) || b(), c = !0) : (l = a.axisX.convertValueToPixel(s), u = a.axisY.convertValueToPixel(r[g].y), d || c ? (!d && h.connectNullData ? (f.setLineDash && (h.options.nullDataLineDashType || Q === h.lineDashType && h.lineDashType !== h.nullDataLineDashType) && (d = l, c = u, l = m.x, u = m.y, b(), f.moveTo(m.x, m.y), l = d, u = c, D = m, Q = h.nullDataLineDashType, f.setLineDash(aa)), f.lineTo(l, Y), f.lineTo(l, u), w && (p.lineTo(l, Y), p.lineTo(l, u))) : (f.beginPath(), f.moveTo(l, u), w && (p.beginPath(), p.moveTo(l, u)), D = {
                                    x: l,
                                    y: u
                                }), c = d = !1) : (f.lineTo(l, Y), w && p.lineTo(l, Y), f.lineTo(l, u), w && p.lineTo(l, u), 0 == g % 250 && b()), m = {
                                    x: l,
                                    y: u
                                }, g < r.length - 1 && (y !== (r[g].lineColor || v) || Q !== (r[g].lineDashType || h.lineDashType)) && (b(), y = r[g].lineColor || v, f.strokeStyle = y, f.setLineDash && (r[g].lineDashType ? (Q = r[g].lineDashType, f.setLineDash(N(Q, h.lineThickness))) : (Q = h.lineDashType, f.setLineDash(E)))), s = h.dataPointIds[g], this._eventManager.objectMap[s] = {
                                    id: s,
                                    objectType: "dataPoint",
                                    dataSeriesIndex: q,
                                    dataPointIndex: g,
        ...
        l.prototype.renderStackedArea = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                V.drawMarkers(p);
                w && (c.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.globalCompositeOperation = "source-atop", a.axisX.maskCanvas && b.drawImage(a.axisX.maskCanvas, 0, 0, this.width, this.height), a.axisY.maskCanvas && b.drawImage(a.axisY.maskCanvas, 0, 0, this.width, this.height), this._breaksCanvasCtx && this._breaksCanvasCtx.drawImage(this._preRenderCanvas, 0, 0, this.width, this.height), b.clearRect(t.x1, t.y1, t.width, t.height), s.restore());
                b.restore();
                return {
                    source: c,
                    dest: this.plotArea.ctx,
                        ...
                        for (var Y = !0, q = 0; q < m.length; q++) {
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !Y)))
                                if ("number" !== typeof fa.y) z.connectNullData || (Y || s) || d(), Y = !0;
                                    ...
                                    g[f] = x - r;
                                    s || Y ? (!s && z.connectNullData ? (b.setLineDash && (z.options.nullDataLineDashType || u === z.lineDashType && z.lineDashType !== z.nullDataLineDashType) && (s = k.pop(), u = k[k.length - 1], d(), b.moveTo(l.x, l.y), k.push(u), k.push(s), u = z.nullDataLineDashType, b.setLineDash(aa)), b.lineTo(h, r), w && A.lineTo(h, r)) : (b.beginPath(), b.moveTo(h, r), w && (A.beginPath(), A.moveTo(h, r))), Y = s = !1) : (b.lineTo(h, r), w && A.lineTo(h, r), 0 == q % 250 && (d(), b.moveTo(h, r), w && A.moveTo(h, r), k.push({
                                        x: h,
                                        y: x - ba
                                    })));
                                    l = {
                                    ...
                                    0 <= z.dataPointIndexes[f] && 0 !== fa.markerSize && (0 < fa.markerSize || 0 < z.markerSize) && (ba = z.getMarkerProperties(q, h, r, b), t.push(ba), f = P(G), w && t.push({
                                        x: h,
                                        y: r,
                                        ctx: A,
                                        type: ba.type,
                    ...
                    if (0 < m.length) {
                        ...
                        for (var n = 0, q = 0, e = 0; e < m.length; e++)
                            if (f = m[e].getTime ? f = m[e].x.getTime() : f = m[e].x, !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[e].y) {
                                ...
                                c.globalAlpha = 1;
                                Math.sqrt((n - f) * (n - f) + (q - p) * (q - p)) < Math.min(h.size, 5) && m.length > Math.min(this.plotArea.width, this.plotArea.height) || (n = k.dataPointIds[e], this._eventManager.objectMap[n] = {
                                    id: n,
                                    objectType: "dataPoint",
                                    dataSeriesIndex: g,
                                    dataPointIndex: e,
                ...
                for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (0 < x.length)
                        for (var A = 5 < r && u.bevelEnabled ? !0 : !1, t = 0; t < x.length; t++)
                            if (x[t].getTime ? h = x[t].x.getTime() : h = x[t].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(x[t].y) && x[t].y.length && "number" === typeof x[t].y[0] && "number" === typeof x[t].y[1] && "number" === typeof x[t].y[2] && "number" === typeof x[t].y[3]) {
                    ...
                    if (0 < A.length)
                        for (var C = 5 < r && x.bevelEnabled ? !0 : !1, p = 0; p < A.length; p++)
                            if (A[p].getTime ? h = A[p].x.getTime() : h = A[p].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(A[p].y) && A[p].y.length && "number" === typeof A[p].y[0] && "number" === typeof A[p].y[1] && "number" === typeof A[p].y[2] && "number" === typeof A[p].y[3] && "number" === typeof A[p].y[4] && 5 === A[p].y.length) {
                                ...
                                c.restore();
                                c.save();
                                0 < aa && (c.beginPath(), c.setLineDash && c.setLineDash(N(F, aa)), c.strokeStyle = Q, c.lineWidth = aa, c.moveTo(t - Y / 2 << 0, n - fa), c.lineTo(t + Y / 2 << 0, n - fa), c.stroke(), c.moveTo(t - Y / 2 << 0, g + fa), c.lineTo(t + Y / 2 << 0, g + fa), c.stroke());
                                c.restore();
                                ...
                                (A[p].indexLabel || x.indexLabel || A[p].indexLabelFormatter || x.indexLabelFormatter) && this._indexLabels.push({
                                    chartType: x.type,
                                    dataPoint: A[p],
                                    dataSeries: x,
                                    point: {
        ...
        l.prototype.renderRangeColumn = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = null,
                    e = this.plotArea,
                    f = 0,
                    p, t, g, f = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                    ...
                    if (0 < h.length)
                        for (var r = 5 < k && q.bevelEnabled ? !0 : !1, f = 0; f < h.length; f++)
                            if (h[f].getTime ? g = h[f].x.getTime() : g = h[f].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(h[f].y) && h[f].y.length && "number" === typeof h[f].y[0] && "number" === typeof h[f].y[1]) {
                                ...
                                var l = a.axisX.reversed ? b + a.plotType.totalDataSeries * k / 2 - (a.previousDataSeriesCount + m) * k << 0 : b - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount + m) * k << 0,
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
                    var A = a.dataSeriesIndexes[x],
                        ...
                        E = 0;
                    if (z)
                        for (e = C._linkedSeries.id, u = 0; u < e; u++) !this.data[u].type.match(/(bar|column)/ig) || !this.data[u].visible || this.data[u].type.match(/(stacked)/ig) && E || (this.data[u].type.match(/(range)/ig) && (f = !0), E++);
                    ...
                    f && (t = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (z ? v : 1))) << 0 : 0.03 * this.width);
                    ...
                    if (0 < D.length)
                        for (var F = C._colorSet, t = 0; t < D.length; t++) {
                            ...
                            if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax) && !s(D[t].y) && D[t].y.length && "number" === typeof D[t].y[0] && "number" === typeof D[t].y[1]) {
                                ...
                                b ? n = ja : h = ja;
                                b ? (q = a.axisX.reversed ? k + (z ? v : 1) * u / 2 - (z ? E - 1 : 0) * u << 0 : k - (z ? v : 1) * u / 2 + (z ? E - 1 : 0) * u << 0, h = a.axisX.reversed ? q - u << 0 : q + u << 0) : (m = a.axisX.reversed ? g + (z ? v : 1) * u / 2 - (z ? E - 1 : 0) * u << 0 : g - (z ? v : 1) * u / 2 + (z ? E - 1 : 0) * u << 0, n = a.axisX.reversed ? m - u << 0 : m + u << 0);
                                !b && q > h && (ja = q, q = h, h = ja);
                                b && m > n && (ja = m, m = n, n = ja);
                                ja = C.dataPointIds[t];
                                ...
                                y(c, Math.min(m, n), Math.min(q, h), Math.max(n, m), Math.max(h, q), e, Q, aa, b);
                                ...
                                if (D[t].indexLabel || C.indexLabel || D[t].indexLabelFormatter || C.indexLabelFormatter) this._indexLabels.push({
                                        ...
                                        indexKeyword: 0,
                                        point: {
                                            x: b ? D[t].y[1] >= D[t].y[0] ? m : n : m + (n - m) / 2,
                                    ...
                                    this._indexLabels.push({
                                        ...
                                        indexKeyword: 1,
                                        point: {
                                            x: b ? D[t].y[1] >= D[t].y[0] ? n : m : m + (n - m) / 2,
                        ...
                        for (var Q = !0; h < n.length; h++)
                            if (u = n[h].x.getTime ? n[h].x.getTime() : n[h].x, !(u < a.axisX.dataInfo.viewPortMin || u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !Q)))
                                if (null !== n[h].y && n[h].y.length && "number" === typeof n[h].y[0] && "number" === typeof n[h].y[1]) {
                                    ...
                                    q || Q ? (m.connectNullData && !q ? (b.setLineDash && (m.options.nullDataLineDashType || z === m.lineDashType && m.lineDashType !== m.nullDataLineDashType) && (g[g.length - 1].newLineDashArray = E, z = m.nullDataLineDashType, b.setLineDash(y)), b.lineTo(r, l), w && e.lineTo(r, l), g.push({
                                        x: r,
                                        y1: l,
                                        y2: s
                                    })) : (b.beginPath(), b.moveTo(r, l), x = {
                                        x: r,
                                        y: l
                                    }, g = [], g.push({
                                        x: r,
                                        y1: l,
                                        y2: s
                                    }), w && (e.beginPath(), e.moveTo(r, l))), Q = q = !1) : (b.lineTo(r, l), g.push({
                                        x: r,
                                        y1: l,
                                        y2: s
                        ...
                        for (h = !1; n < m.length; n++)
                            if (q = m[n].x.getTime ? m[n].x.getTime() : m[n].x, !(q < a.axisX.dataInfo.viewPortMin || q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !h)))
                                if (null !== m[n].y && m[n].y.length && "number" === typeof m[n].y[0] && "number" === typeof m[n].y[1]) {
                                    ...
                                    n < m.length - 1 && (A !== (m[n].lineColor || x) || C !== (m[n].lineDashType || k.lineDashType)) && (A = m[n].lineColor || x, l[l.length - 1].newStrokeStyle = A, b.setLineDash && (m[n].lineDashType ? (C = m[n].lineDashType, l[l.length - 1].newLineDashArray = N(C, k.lineThickness)) : (C = k.lineDashType, l[l.length - 1].newLineDashArray = D)));
                                    ...
                                    h = !1
                                } else 0 < n && !h && (k.connectNullData ? b.setLineDash && (0 < l.length && (k.options.nullDataLineDashType || !m[n - 1].lineDashType)) && (l[l.length - 1].newLineDashArray = z, C = k.nullDataLineDashType) : (d(D, x), l = [], s = [])), h = !0;
                        d(D, x);
                        V.drawMarkers(f)
                    }
                }
        ...
        l.prototype.renderWaterfall = function(a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var b = this._eventManager.ghostCtx,
                    ...
                    f = this.plotArea,
                    p = 0,
                    t, g, k, m, n = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0),
        ...
        var W = function(a, d, c, b, e, f, p, g, l) {
            if (!(0 > c)) {
                ...
                a.save();
                a.globalAlpha = g;
                "pie" === e ? (a.beginPath(), a.moveTo(d.x, d.y), a.arc(d.x, d.y, c, f, p, !1), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth = 2, a.closePath(), a.fill()) : "doughnut" === e && (a.beginPath(), a.arc(d.x, d.y, c, f, p, !1), 0 <= l && a.arc(d.x, d.y, l * c, p, f, !0), a.closePath(), a.fillStyle = b, a.strokeStyle = "white", a.lineWidth = 2, a.fill());
                a.globalAlpha = 1;
                a.restore()
            }
        };
            ...
            function d() {
                if (k && m) {
                    for (var a = 0, b = 0, c = 0, d = 0, e = 0; e < m.length; e++) {
                        ...
                        n = f.indexLabelFormatter ? f.indexLabelFormatter(t) : f.indexLabel ? l.replaceKeywordsWithValue(f.indexLabel, f, k, e) : k.indexLabelFormatter ? k.indexLabelFormatter(t) : k.indexLabel ? l.replaceKeywordsWithValue(k.indexLabel, f, k, e) : f.label ? f.label : "";
            ...
            function c(a) {
                ...
                for (b = 0; b < m.length; b++) {
                    ...
                    if (d > c) {
                        ...
                        W(l.plotArea.ctx, h[b].center, h[b].radius, m[b].color ? m[b].color : k._colorSet[b % k._colorSet.length], k.type, c, d, k.fillOpacity, h[b].percentInnerRadius)
                    }
                }
                a = l.plotArea.ctx;
                a.save();
                ...
                a.lineJoin = "round";
                for (b = b = 0; b < m.length; b++) c = h[b], c.indexLabelText && (c.indexLabelTextBlock.y -= c.indexLabelTextBlock.height / 2, d = 0, d = "left" === c.hemisphere ? "inside" !== k.indexLabelPlacement ? -(c.indexLabelTextBlock.width + n) : -c.indexLabelTextBlock.width / 2 : "inside" !== k.indexLabelPlacement ? n : -c.indexLabelTextBlock.width / 2, c.indexLabelTextBlock.x += d, c.indexLabelTextBlock.render(!0), c.indexLabelTextBlock.x -= d, c.indexLabelTextBlock.y += c.indexLabelTextBlock.height / 2, "inside" !== c.indexLabelPlacement && 0 < c.indexLabelLineThickness && (d = c.center.x + z * Math.cos(c.midAngle), e = c.center.y + z * Math.sin(c.midAngle), a.strokeStyle = c.indexLabelLineColor, a.lineWidth = c.indexLabelLineThickness, a.setLineDash && a.setLineDash(N(c.indexLabelLineDashType, c.indexLabelLineThickness)), a.beginPath(), a.moveTo(d, e), a.lineTo(c.indexLabelTextBlock.x, c.indexLabelTextBlock.y), a.lineTo(c.indexLabelTextBlock.x + ("left" === c.hemisphere ? -n : n), c.indexLabelTextBlock.y), a.stroke()), a.lineJoin = "miter");
                a.save()
            }
                ...
                if (0 <= a && a < m.length) {
                    ...
                    for (g = 1; g < m.length; g++)
                        if (p = (a - g + h.length) % h.length, h[p].hemisphere !== h[a].hemisphere) {
                            p = null;
                            break
                        } else if (h[p].indexLabelText && h[p].hemisphere === h[a].hemisphere && p !== a && (0 > b(h[p], h[a]) || ("right" === h[a].hemisphere ? h[p].indexLabelTextBlock.y <= h[a].indexLabelTextBlock.y : h[p].indexLabelTextBlock.y >= h[a].indexLabelTextBlock.y))) break;
                    else p = null;
                    t = p;
                    q = e(a);
                    g = p = 0;
                    0 > c ? (g = "right" === n.hemisphere ? t : q, k = c, null !== g && (t = -c, c = n.indexLabelTextBlock.y - n.indexLabelTextBlock.height / 2 - (h[g].indexLabelTextBlock.y + h[g].indexLabelTextBlock.height / 2), c - t < r && (p = -t, g = f(g, p, d + 1), +g.toFixed(x) > +p.toFixed(x) && (k = c > r ? -(c - r) : -(t - (g - p)))))) : 0 < c && (g = "right" === n.hemisphere ? q : t, k = c, null !== g && (t = c, c = h[g].indexLabelTextBlock.y - h[g].indexLabelTextBlock.height / 2 - (n.indexLabelTextBlock.y + n.indexLabelTextBlock.height / 2), c - t < r && (p = t, g = f(g, p, d + 1), +g.toFixed(x) < +p.toFixed(x) && (k = c > r ? c - r : t - (p - g)))));
                    k && (d = n.indexLabelTextBlock.y + k, c = 0, c = "right" === n.hemisphere ? A.x + Math.sqrt(Math.pow(w, 2) - Math.pow(d - A.y, 2)) : A.x - Math.sqrt(Math.pow(w, 2) - Math.pow(d - A.y, 2)), n.midAngle > Math.PI / 2 - u && n.midAngle < Math.PI / 2 + u ? (p = (a - 1 + h.length) % h.length, p = h[p], a = h[(a + 1 + h.length) % h.length], "left" === n.hemisphere && "right" === p.hemisphere && c > p.indexLabelTextBlock.x ? c = p.indexLabelTextBlock.x - 15 : "right" === n.hemisphere && ("left" === a.hemisphere && c < a.indexLabelTextBlock.x) && (c = a.indexLabelTextBlock.x + 15)) : n.midAngle > 3 * Math.PI / 2 - u && n.midAngle < 3 * Math.PI / 2 + u && (p = (a - 1 + h.length) % h.length, p = h[p], a = h[(a + 1 + h.length) % h.length], "right" === n.hemisphere && "left" === p.hemisphere && c < p.indexLabelTextBlock.x ? c = p.indexLabelTextBlock.x + 15 : "left" === n.hemisphere && ("right" === a.hemisphere && c > a.indexLabelTextBlock.x) && (c = a.indexLabelTextBlock.x - 15)), n.indexLabelTextBlock.y = d, n.indexLabelTextBlock.x = c, n.indexLabelAngle = Math.atan2(n.indexLabelTextBlock.y - A.y, n.indexLabelTextBlock.x - A.x))
                }
                return k
            }
                        ...
                        for (var t, u, a = 0; a < m.length; a++) {
                            ...
                            if (null !== s) {
                                ...
                                if (0 > C) {
                                    ...
                                    var D = -1 * (C - u),
                                        J = F = 0;
                                    "right" === g.hemisphere ? (F = f(a, u), D = -1 * (C - F), J = f(s, D), +J.toFixed(x) < +D.toFixed(x) && +F.toFixed(x) <= +u.toFixed(x) && f(a, -(D - J))) : (F = f(s, u), D = -1 * (C - F), J = f(a, D), +J.toFixed(x) < +D.toFixed(x) && +F.toFixed(x) <= +u.toFixed(x) && f(s, -(D - J)))
                                }
                            }
                        }
                    } else
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                if (0 !== C) {
                    ...
                    this.pieDoughnutClickHandler = function(a) {
                        l.isAnimating || !s(a.dataSeries.explodeOnClick) && !a.dataSeries.explodeOnClick || (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, 1 < this.dataPoints.length && l._animator.animate(0, 500, function(a) {
                            c(a);
                            g();
                    ...
                    this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function(a) {
                        ...
                        for (var b = h[0].startAngle + 2 * Math.PI * a, c = 0; c < m.length; c++) {
                            ...
                            e > d && W(l.plotArea.ctx, h[c].center, h[c].radius, p, k.type, d, e, k.fillOpacity, h[c].percentInnerRadius);
                            if (f) break
                        }
                        g();
                        l.dispatchEvent("dataAnimationIterationEnd", {
        ...
        l.prototype.renderFunnel = function(a) {
            ...
            function b() {
                if (u && x) {
                    ...
                    for (var z = 0, D = x.length - 1; z < x.length || 0 <= D; z++, D--) {
                        ...
                        b = b.indexLabelFormatter ? b.indexLabelFormatter(C) : b.indexLabel ? y.replaceKeywordsWithValue(b.indexLabel, b, u, z) : u.indexLabelFormatter ? u.indexLabelFormatter(C) : u.indexLabel ? y.replaceKeywordsWithValue(u.indexLabel, b, u, z) : b.label ? b.label : "";
                        0 >= m && (m = 0);
            ...
            function f() {
                ...
                if ("inside" !== u.indexLabelPlacement)
                    for (var e = 0; e < O.length; e++) 0 == I[e].textBlock.text.length ? I[e].isDirty = !0 : (a = O[e], c = "undefined" !== typeof a.x5 ? (a.y2 + a.y4) / 2 : (a.y2 + a.y3) / 2, b = u.reversed ? "undefined" !== typeof a.x5 ? c > xa ? h(c).x2 + 1 : (a.x2 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1 : "undefined" !== typeof a.x5 ? c < xa ? h(c).x2 + 1 : (a.x4 + a.x3) / 2 + 1 : (a.x2 + a.x3) / 2 + 1, I[e].textBlock.x = b + U, I[e].textBlock.y = c - I[e].height / 2, u.reversed ? (I[e].textBlock.y + I[e].height > na + C && (I[e].textBlock.y = na + C - I[e].height), I[e].textBlock.y < sa - C && (I[e].textBlock.y = sa - C)) : (I[e].textBlock.y < na - C && (I[e].textBlock.y = na - C), I[e].textBlock.y + I[e].height > sa + C && (I[e].textBlock.y = sa + C - I[e].height)));
                else
            ...
            function p() {
                ...
                function b() {
                    ...
                    for (var p, g = 1; g < k; g++) {
                        e = g * f;
                        for (var t = I.length - 1; 0 <= t; t--) !I[t].isDirty && (I[t].textBlock.y < e && I[t].textBlock.y + I[t].height > e) && (p = q(t), !(p >= I.length - 1) && I[t].textBlock.y + I[t].height + da > I[p].textBlock.y && (I[t].textBlock.y = I[t].textBlock.y + I[t].height - e > e - I[t].textBlock.y ? e + 1 : e - I[t].height - 1))
                    }
                ...
                for (var d, e, f, h, k, p, m = 1, l = 0; l < 2 * m; l++) {
                    for (var r = I.length - 1; 0 <= r && !(0 <= n(r) && n(r), f = I[r], h = f.textBlock, p = (k = q(r) < O.length ? I[q(r)] : null) ? k.textBlock : null, d = +f.height.toFixed(6), e = +h.y.toFixed(6), !f.isDirty && (k && e + d + da > +p.y.toFixed(6)) && (d = h.y + d + da - p.y, e = a(r, -d), e < d && (0 < e && (d -= e), e = a(q(r), d), e != d))); r--);
                    b()
                }
            }
            ...
            function l(a, b, c) {
                ...
                var q = {
                    ...
                    changeSection: function(a) {
                        for (var b, c, d = 0; d < O.length; d++) b = h[d], c = O[d], b *= a, "undefined" === typeof n[d] && (n[d] = 0), 0 > n && (n *= -1), c.y1 += b - n[d], c.y2 += b - n[d], c.y3 += b - n[d], c.y4 += b - n[d], c.y5 && (c.y5 += b - n[d], c.y6 += b - n[d]), n[d] = b
                    }
                };
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                for (var u = this.data[a.dataSeriesIndexes[0]], x = u.dataPoints, A = this.plotArea, C = 0.025 * A.width, D = 0.01 * A.width, z = 0, E = A.height - 2 * C, F = Math.min(A.width - 2 * D, 2.8 * A.height), J = !1, H = 0; H < x.length; H++)
                    if (!J && ("undefined" !== typeof x[H].indexLabel && null !== x[H].indexLabel && 0 < x[H].indexLabel.toString().length) && (J = !0), !J && ("undefined" !== typeof x[H].label && null !== x[H].label && 0 < x[H].label.toString().length) && (J = !0), !J && "function" === typeof u.indexLabelFormatter || "function" === typeof x[H].indexLabelFormatter) J = !0;
                ...
                if (0 != u.length && (u.dataPoints && u.visible) && 0 !== x.length) {
                    ...
                    a = 75 * F / 100;
                    var U = 30 * (M - a) / 100;
                    "funnel" === u.type ? (ba = s(u.options.neckHeight) ? 0.35 * E : u.neckHeight, G = s(u.options.neckWidth) ? 0.25 * a : u.neckWidth, "string" === typeof ba && ba.match(/%$/) ? (ba = parseInt(ba), ba = ba * E / 100) : ba = parseInt(ba), "string" === typeof G && G.match(/%$/) ? (G = parseInt(G), G = G * a / 100) : G = parseInt(G), ba > E ? ba = E : 0 >= ba && (ba = 0), G > a ? G = a - 0.5 : 0 >= G && (G = 0)) : "pyramid" === u.type && (G = ba = 0, u.reversed = u.reversed ? !1 : !0);
                    var D = H + a / 2,
                        X = H,
                        Z = H + a,
                        na = u.reversed ? P : Y,
                    ...
                    if (-1 !== H) {
                        if (u.reversed)
                            for (F.push(T), G = H.length - 1; 0 < G; G--) T += H[G], F.push(T);
                        else
        ...
        l.prototype.replaceKeywordsWithValue = function(a, d, c, b, e) {
            ...
            return a.replace(/\{.*?\}|"[^"]*"|'[^']*'/g, function(a) {
                ...
                else return "y" === a ? ea(h, d.yValueFormatString ? d.yValueFormatString : c.yValueFormatString ? c.yValueFormatString : c.yValueFormatString = "#,##0.########", f._cultureInfo) : "z" === a ? ea(h, d.zValueFormatString ? d.zValueFormatString : c.zValueFormatString ? c.zValueFormatString : c.zValueFormatString = "#,##0.########", f._cultureInfo) : h
            })
        };
        oa(F, U);
        ...
        F.prototype.render = function() {
            ...
            for (var g = 0, l = 0; l < p.length; l++) {
                for (var k = p[l], m = 0, n = 0; n < k.items.length; n++) {
                    ...
                    this.ctx.clip();
                    if ("line" === q.chartType || "stepLine" === q.chartType || "spline" === q.chartType) this.ctx.strokeStyle = q.lineColor, this.ctx.lineWidth = Math.ceil(this.lineHeight / 8), this.ctx.beginPath(), this.ctx.moveTo(h - 0.1 * this.lineHeight, r + this.lineHeight / 2), this.ctx.lineTo(h + 0.85 * this.lineHeight, r + this.lineHeight / 2), this.ctx.stroke(), s -= 0.1 * this.lineHeight;
                    ...
                    V.drawMarker(h + f / 2, r + this.lineHeight / 2, this.ctx, q.markerType, "error" === q.chartType || "line" === q.chartType || "spline" === q.chartType ? q.markerSize / 2 : q.markerSize, q.markerColor, q.markerBorderColor, q.markerBorderThickness);
                    q.textBlock.x = h + c + f;
        ...
        E.prototype.createLabels = function() {
            ...
            if ("axisX" !== this.type || "dateTime" !== this.valueType || this.logarithmic) {
                ...
                for (this.intervalStartPosition = this.getLabelStartPoint(new Date(this.viewportMinimum), this.intervalType, this.interval), e = Va(new Date(this.viewportMaximum), this.interval, this.intervalType), h = q, c = this.intervalStartPosition; c < e; Va(c, b, this.intervalType)) {
                    ...
                    a || (a = this.labelFormatter ? this.labelFormatter({
                        ...
                        value: new Date(m),
                        label: this.labels[m] ? this.labels[m] : null
                    }) : "axisX" === this.type && this.labels[m] ? this.labels[m] : Aa(m, this.valueFormatString, this.chart._cultureInfo), a = new ia(this.ctx, {
                        x: 0,
                        y: 0,
                        maxWidth: f,
                        backgroundColor: this.labelBackgroundColor,
            ...
            if (this.labelAutoFit || this.options.labelAutoFit)
                    ...
                    if (f = 0.9 * g >> 0, q = 0, !this.chart.panEnabled && 1 <= this._labels.length) {
                        ...
                        for (c = 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                for (var v, h = a.text.split(" "), b = 0; b < h.length; b++) m = h[b], this.ctx.font = a.fontStyle + " " + a.fontWeight + " " + a.fontSize + "px " + a.fontFamily, m = this.ctx.measureText(m), m.width > q && (v = c, q = m.width)
                            } c = 0;
                                ...
                                if (s(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                    if (this.sessionVariables.labelMaxHeight = 0 === this.labelAngle ? p : Math.min((b - f * Math.cos(Math.PI / 180 * Math.abs(this.labelAngle))) / Math.sin(Math.PI / 180 * Math.abs(this.labelAngle)), b), m = (k - (l + a.fontSize / 2) * Math.cos(Math.PI / 180 * Math.abs(-25))) / Math.sin(Math.PI / 180 * Math.abs(-25)), !s(this.options.labelWrap)) this.labelWrap ? s(this.options.labelMaxWidth) ? (this.sessionVariables.labelMaxWidth = Math.min(Math.max(f, q), m), this.sessionVariables.labelWrap = this.labelWrap, d && r.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25)) : (this.sessionVariables.labelWrap = this.labelWrap, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > f ? -25 : this.sessionVariables.labelAngle) : s(this.options.labelMaxWidth) ? (this.sessionVariables.labelWrap = this.labelWrap, this.sessionVariables.labelMaxHeight = p, this.sessionVariables.labelMaxWidth = f, d && r.width + d.width >> 0 > 2 * f && (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = m)) : (this.sessionVariables.labelAngle = this.sessionVariables.labelMaxWidth > f ? -25 : this.sessionVariables.labelAngle, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = p, this.sessionVariables.labelWrap = this.labelWrap);
                                        ...
                                        if (s(this.options.labelWrap))
                                            if (!s(this.options.labelMaxWidth)) this.options.labelMaxWidth < f ? (this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = b) : (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = this.options.labelMaxWidth, this.sessionVariables.labelMaxHeight = p);
                                            else if (!s(d))
                                            if (b = r.width + d.width >> 0, h = this.labelFontSize, q < f) b - 2 * f > n && (n = b - 2 * f, b >= 2 * f && b < 2.2 * f ? (this.sessionVariables.labelMaxWidth = f, s(this.options.labelFontSize) && 12 < h && (h = Math.floor(12 / 13 * h), a.measureText()), this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? h : this.options.labelFontSize, this.sessionVariables.labelAngle = this.labelAngle) : b >= 2.2 * f && b < 2.8 * f ? (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = m, this.sessionVariables.labelFontSize = h) : b >= 2.8 * f && b < 3.2 * f ? (this.sessionVariables.labelMaxWidth = Math.max(f, q), this.sessionVariables.labelWrap = !0, s(this.options.labelFontSize) && 12 < this.labelFontSize && (this.labelFontSize = Math.floor(12 / 13 * this.labelFontSize), a.measureText()), this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? h : this.options.labelFontSize, this.sessionVariables.labelAngle = this.labelAngle) : b >= 3.2 * f && b < 3.6 * f ? (this.sessionVariables.labelAngle = -25, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = m, this.sessionVariables.labelFontSize = this.labelFontSize) : b > 3.6 * f && b < 5 * f ? (s(this.options.labelFontSize) && 12 < h && (h = Math.floor(12 / 13 * h), a.measureText()), this.sessionVariables.labelFontSize = s(this.options.labelFontSize) ? h : this.options.labelFontSize, this.sessionVariables.labelWrap = !0, this.sessionVariables.labelAngle = -25, this.sessionVariables.labelMaxWidth = m) : b > 5 * f && (this.sessionVariables.labelWrap = !0, this.sessionVariables.labelMaxWidth = f, this.sessionVariables.labelFontSize = h, this.sessionVariables.labelMaxHeight = p, this.sessionVariables.labelAngle = this.labelAngle));
                        ...
                        for (c = 0; c < this._labels.length; c++) a = this._labels[c].textBlock, a.maxWidth = this.labelMaxWidth = s(this.options.labelMaxWidth) ? s(this.sessionVariables.labelMaxWidth) ? this.sessionVariables.labelMaxWidth = f : this.sessionVariables.labelMaxWidth : this.options.labelMaxWidth, a.fontSize = this.labelFontSize = s(this.options.labelFontSize) ? s(this.sessionVariables.labelFontSize) ? this.sessionVariables.labelFontSize = this.labelFontSize : this.sessionVariables.labelFontSize : this.options.labelFontSize, a.angle = this.labelAngle = s(this.options.labelAngle) ? s(this.sessionVariables.labelAngle) ? this.sessionVariables.labelAngle = this.labelAngle : this.sessionVariables.labelAngle : this.labelAngle, a.wrap = this.labelWrap = s(this.options.labelWrap) ? s(this.sessionVariables.labelWrap) ? this.sessionVariables.labelWrap = this.labelWrap : this.sessionVariables.labelWrap : this.options.labelWrap, a.maxHeight = s(this.sessionVariables.labelMaxHeight) ? this.sessionVariables.labelMaxHeight = p : this.sessionVariables.labelMaxHeight,
                            a.measureText();
                ...
                if (f = s(this.options.labelMaxWidth) ? 0.3 * this.chart.width >> 0 : this.options.labelMaxWidth, p = "undefined" === typeof this.options.labelWrap || this.labelWrap ? 0.3 * this.chart.height >> 0 : 1.5 * this.labelFontSize, !this.chart.panEnabled && 1 <= this._labels.length) {
                    ...
                    for (c = 0; c < this._labels.length; c++) a = this._labels[c].textBlock, a.maxWidth = this.labelMaxWidth = s(this.options.labelMaxWidth) ? s(this.sessionVariables.labelMaxWidth) ? this.sessionVariables.labelMaxWidth = f : this.sessionVariables.labelMaxWidth : this.options.labelMaxWidth, a.fontSize = this.labelFontSize = s(this.options.labelFontSize) ? s(this.sessionVariables.labelFontSize) ? this.sessionVariables.labelFontSize = this.labelFontSize : this.sessionVariables.labelFontSize : this.options.labelFontSize, a.angle = this.labelAngle = s(this.options.labelAngle) ? s(this.sessionVariables.labelAngle) ? this.sessionVariables.labelAngle = this.labelAngle : this.sessionVariables.labelAngle : this.labelAngle, a.wrap = this.labelWrap = s(this.options.labelWrap) ? s(this.sessionVariables.labelWrap) ? this.sessionVariables.labelWrap = this.labelWrap : this.sessionVariables.labelWrap : this.options.labelWrap, a.maxHeight = s(this.sessionVariables.labelMaxHeight) ? this.sessionVariables.labelMaxHeight = p : this.sessionVariables.labelMaxHeight, a.measureText();
        ...
        E.setLayout = function(a, d, c, b, e, f) {
            ...
            if ("normal" === e) {
                for (var x = [], A = [], y = [], D = [], M = [], N = [], P = [], R = []; 4 > w;) {
                    ...
                    N.push(A);
                    if (a && 0 < a.length)
                        for (h = 0; h < a.length; h++) a[h] && (a[h].lineCoordinates.x1 = p, l = Math.round(f.x2 - $ - Z > m.width - n ? m.width - n : f.x2 - $ - Z), a[h]._labels && 1 < a[h]._labels.length && (g = k = 0, k = a[h]._labels[1], g = "dateTime" === a[h].valueType ? a[h]._labels[a[h]._labels.length - 2] : a[h]._labels[a[h]._labels.length - 1], v = k.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(k.textBlock.angle)) + (k.textBlock.height - g.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(k.textBlock.angle)), u = g.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(g.textBlock.angle)) + (g.textBlock.height - g.textBlock.fontSize / 2) * Math.sin(Math.PI / 180 * Math.abs(g.textBlock.angle))), !a[h] || (!a[h].labelAutoFit || s(z) || s(E) || m.isNavigator || m.stockChart) || (g = 0, 0 < a[h].labelAngle ? E + u > l && (g += 0 < a[h].labelAngle ? E + u - l - $ : 0) : 0 > a[h].labelAngle ? z - v < p && z - v < a[h].viewportMinimum && (F = p - (L + a[h].tickLength + y + z - v + a[h].labelFontSize / 2)) : 0 === a[h].labelAngle && (E + u > l && (g = E + u / 2 - l - $), z - v < p && z - v < a[h].viewportMinimum && (F = p - L - a[h].tickLength - y - z + v / 2)), a[h].viewportMaximum === a[h].maximum && a[h].viewportMinimum === a[h].minimum && 0 < a[h].labelAngle && 0 < g ? l -= g : a[h].viewportMaximum === a[h].maximum && a[h].viewportMinimum === a[h].minimum && 0 > a[h].labelAngle && 0 < F ? p += F : a[h].viewportMaximum === a[h].maximum && a[h].viewportMinimum === a[h].minimum && 0 === a[h].labelAngle && (0 < F && (p += F), 0 < g && (l -= g))), m.panEnabled ? T = s(m.sessionVariables.axisX.height) ? m.sessionVariables.axisX.height = T : m.sessionVariables.axisX.height : m.sessionVariables.axisX.height = T, g = Math.round(f.y2 - T - e + G), k = Math.round(f.y2), a[h].lineCoordinates.x2 = l, a[h].lineCoordinates.width = l - p, a[h].lineCoordinates.y1 = g, a[h].lineCoordinates.y2 = g + a[h].lineThickness / 2, "inside" === a[h].labelPlacement && 0 < h && (a[h].lineCoordinates.y1 = a[h].lineCoordinates.y1 + x[h] - (a[h]._titleTextBlock ? a[h]._titleTextBlock.height : 0) - ("inside" === a[h].tickPlacement ? a[h].tickLength : 0), a[h].lineCoordinates.y2 = a[h].lineCoordinates.y1 + a[h].lineThickness / 2), a[h].bounds = {
                            x1: p,
                            y1: g,
                            x2: l,
                            y2: k - (T + e - x[h] - G),
                    ...
                    if (c && 0 < c.length)
                        for (h = 0; h < c.length; h++) L = m.isNavigator ? 0 : 10, c[h] && (p = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), L = c[h]._labels && 0 < c[h]._labels.length ? c[h]._labels[c[h]._labels.length - 1].textBlock.height / 2 : n, g = Math.round(f.y1 + V + W < Math.max(L, n) ? Math.max(L, n) : f.y1 + V + W), l = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1), L = 0 < a.length ? 0 : c[h]._labels && 0 < c[h]._labels.length ? c[h]._labels[0].textBlock.height / 2 : n, k = Math.round(f.y2 - T - e - L), c[h].lineCoordinates = {
                            ...
                            width: l - p,
                            height: k - g
                        }, c[h].title && (c[h]._titleTextBlock.maxWidth = 0 < c[h].titleMaxWidth && c[h].titleMaxWidth < c[h].lineCoordinates.height ? c[h].titleMaxWidth : c[h].lineCoordinates.height), U += y[h] + c[h].margin);
                    if (b && 0 < b.length)
                    ...
                    if (0 < w) {
                        ...
                        if (b && 0 < b.length)
                            for (h = 0; h < b.length; h++) K = R[w - 1][h] === R[w][h] ? !0 : !1;
                        else K = !0
                    }
                    if (r && H && J && K) break;
                    w++
                ...
                for (N = []; 4 > w;) {
                    ...
                    if (b && 0 < b.length)
                        for (h = b.length - 1; 0 <= h; h--) b[h] && (g = Math.round(f.y1), k = Math.round(f.y1 + (z[h] + b[h].margin + G)), b[h].lineCoordinates.y1 = k, b[h].lineCoordinates.y2 = k, "inside" === b[h].labelPlacement && 0 < h && (b[h].lineCoordinates.y1 = k - z[h] + (b[h]._titleTextBlock ? b[h]._titleTextBlock.height : 0)), b[h].bounds = {
                            x1: p,
                            y1: g + (b[h].margin + G),
                            x2: l,
                            y2: k,
                    ...
                    if (a && 0 < a.length)
                        for (h = 0; h < a.length; h++) {
                            ...
                            if (c && 0 < c.length)
                                for (L = 0; L < c.length; L++) c[L] && c[L].labelAutoFit && (l = 0 > c[L].labelAngle ? Math.max(l, x) : 0 === c[L].labelAngle ? Math.max(l, x / 2) : l, p = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? l - X : p);
                            if (b && 0 < b.length)
                    ...
                    if (d && 0 < d.length)
                        for (h = 0; h < d.length; h++) {
                            ...
                            if (b && 0 < b.length)
                                for (L = 0; L < b.length; L++) b[L] && b[L].labelAutoFit && (l = b[L].lineCoordinates.x2, p = l - T);
                            d[h].lineCoordinates = {
                                x1: l + R,
                                y1: g,
                                x2: l + R,
            ...
            if ("undefined" === typeof this.options.interval) {
                if ("bottom" === this._position || "top" === this._position)
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var c = [], e = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, g, l = this.viewportMaximum, s = this.lineCoordinates.width / Math.log(this.range), k = this._labels.length - 1; 0 <= k; k--) {
                            n = this._labels[k];
                        ...
                        for (k = 0; k < this._labels.length; k++) n = this._labels[k], n.position < this.viewportMinimum || (g = n.textBlock.width * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.height * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)), c += g);
                    ...
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var c = [], m, l = this.viewportMaximum, s = this.lineCoordinates.height / Math.log(this.range), k = this._labels.length - 1; 0 <= k; k--) {
                            n = this._labels[k];
                            if (n.position < this.viewportMinimum) break;
                            n.position > this.viewportMaximum || !(k === this._labels.length - 1 || m < Math.log(l / n.position) * s) || (c.push(n), l = n.position, m = n.textBlock.height * Math.abs(Math.cos(Math.PI / 180 * this.labelAngle)) + n.textBlock.width * Math.abs(Math.sin(Math.PI / 180 * this.labelAngle)))
                        }
                        this._labels = c
                    } else {
        ...
        E.prototype.renderStripLinesOfThicknessType = function(a) {
            if (this.stripLines && 0 < this.stripLines.length && a) {
                ...
                for (b = 0; b < this._stripLineLabels.length; b++)
                    ...
                    this.ctx.clip();
                    for (b = 0; b < l.length; b++) k = l[b], k.showOnTop ? f || (f = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() {
                        this.ctx.save();
                        this.ctx.beginPath();
                        this.ctx.rect(this.chart.plotArea.x1, this.chart.plotArea.y1, this.chart.plotArea.width, this.chart.plotArea.height);
                        this.ctx.clip();
                    ...
                    for (b = 0; b < w.length; b++) c = w[b], c.stripLine.showOnTop ? g || (g = !0, this.chart.addEventListener("dataAnimationIterationEnd", function() {
                        for (e = 0; e < w.length; e++) c = w[e], "inside" === c.stripLine.labelPlacement && c.stripLine.showOnTop && (d.ctx.save(), d.ctx.beginPath(), d.ctx.rect(d.chart.plotArea.x1, d.chart.plotArea.y1, d.chart.plotArea.width, d.chart.plotArea.height), d.ctx.clip(), c.textBlock.render(!0), d.ctx.restore())
                ...
                if (this.lineThickness) {
                    ...
                    if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex))
                        if (s(this.scaleBreaks.lastBreakIndex)) e = this.scaleBreaks._appliedBreaks[this.scaleBreaks.firstBreakIndex].endPixel + b;
                            ...
                            for (var l = this.scaleBreaks.firstBreakIndex; l <= this.scaleBreaks.lastBreakIndex; l++) d.moveTo(e, g), d.lineTo(this.scaleBreaks._appliedBreaks[l].startPixel + c, g), e = this.scaleBreaks._appliedBreaks[l].endPixel + b;
        ...
        E.prototype.calculateValueToPixelConversionParameters = function(a) {
            ...
            if (this.logarithmic)
                for (var e = 0; e < a.length && !(this.viewportMaximum < a[e].startValue); e++) this.viewportMinimum > a[e].endValue || (this.viewportMinimum >= a[e].startValue && this.viewportMaximum <= a[e].endValue ? c = 0 : this.viewportMinimum <= a[e].startValue && this.viewportMaximum >= a[e].endValue ? (b = b / a[e].endValue * a[e].startValue, c = 0 < a[e].spacing.toString().indexOf("%") ? c * (1 - parseFloat(a[e].spacing) / 100) : c - Math.min(a[e].spacing, 0.1 * c)) : this.viewportMinimum > a[e].startValue && this.viewportMaximum >= a[e].endValue ? (b = b / a[e].endValue * this.viewportMinimum, c = 0 < a[e].spacing.toString().indexOf("%") ? c * (1 - parseFloat(a[e].spacing) / 100 * Math.log(a[e].endValue / this.viewportMinimum) / Math.log(a[e].endValue / a[e].startValue)) : c - Math.min(a[e].spacing, 0.1 * c) * Math.log(a[e].endValue / this.viewportMinimum) / Math.log(a[e].endValue / a[e].startValue)) : this.viewportMinimum <= a[e].startValue && this.viewportMaximum < a[e].endValue && (b = b / this.viewportMaximum * a[e].startValue, c = 0 < a[e].spacing.toString().indexOf("%") ? c * (1 - parseFloat(a[e].spacing) / 100 * Math.log(this.viewportMaximum / a[e].startValue) / Math.log(a[e].endValue / a[e].startValue)) : c - Math.min(a[e].spacing, 0.1 * c) * Math.log(this.viewportMaximum / a[e].startValue) / Math.log(a[e].endValue / a[e].startValue)));
            else
                for (e = 0; e < a.length && !(this.viewportMaximum < a[e].startValue); e++) this.viewportMinimum > a[e].endValue || (this.viewportMinimum >= a[e].startValue && this.viewportMaximum <= a[e].endValue ? c = 0 : this.viewportMinimum <= a[e].startValue && this.viewportMaximum >= a[e].endValue ? (b = b - a[e].endValue + a[e].startValue, c = 0 < a[e].spacing.toString().indexOf("%") ? c * (1 - parseFloat(a[e].spacing) / 100) : c - Math.min(a[e].spacing, 0.1 * c)) : this.viewportMinimum > a[e].startValue && this.viewportMaximum >= a[e].endValue ? (b = b - a[e].endValue + this.viewportMinimum, c = 0 < a[e].spacing.toString().indexOf("%") ? c * (1 - parseFloat(a[e].spacing) / 100 * (a[e].endValue - this.viewportMinimum) / (a[e].endValue - a[e].startValue)) : c - Math.min(a[e].spacing, 0.1 * c) * (a[e].endValue - this.viewportMinimum) / (a[e].endValue - a[e].startValue)) : this.viewportMinimum <= a[e].startValue && this.viewportMaximum < a[e].endValue && (b = b - this.viewportMaximum + a[e].startValue, c = 0 < a[e].spacing.toString().indexOf("%") ? c * (1 - parseFloat(a[e].spacing) / 100 * (this.viewportMaximum - a[e].startValue) / (a[e].endValue - a[e].startValue)) : c - Math.min(a[e].spacing, 0.1 * c) * (this.viewportMaximum - a[e].startValue) / (a[e].endValue - a[e].startValue)));
            ...
            if (this.logarithmic) this.calculateLogarithmicAxisParameters();
                ...
                if (null === this.minimum || null === this.maximum)
                    if ("axisX" === this.type ? (e = null !== this.minimum ? this.minimum : this.dataInfo.min, f = null !== this.maximum ? this.maximum : this.dataInfo.max, 0 === f - e && (b = "undefined" === typeof this.options.interval ? 0.4 : this.options.interval, f += b, e -= b), g = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < f - e ? 0.5 * Math.abs(f - e) : 1) : "axisY" === this.type && (e = null !== this.minimum ? this.minimum : this.dataInfo.min, f = null !== this.maximum ? this.maximum : this.dataInfo.max, isFinite(e) || isFinite(f) ? 0 === e && 0 === f ? (f += 9, e = 0) : 0 === f - e ? (b = Math.min(Math.abs(0.01 * Math.abs(f)), 5), f += b, e -= b) : e > f ? (b = Math.min(0.01 * Math.abs(this.getApparentDifference(f, e, null, !0)), 5), 0 <= f ? e = f - b : f = isFinite(e) ? e + b : 0) : (b = Math.min(0.01 * Math.abs(this.getApparentDifference(e, f, null, !0)), 0.05), 0 !== f && (f += b), 0 !== e && (e -= b)) : (f = "undefined" === typeof this.options.interval ? -Infinity : this.options.interval, e = "undefined" !== typeof this.options.interval || isFinite(this.dataInfo.minDiff) ? 0 : Infinity), g = Infinity !== this.dataInfo.minDiff ? this.dataInfo.minDiff : 1 < f - e ? 0.5 * Math.abs(f - e) : 1, this.includeZero && (null === this.minimum || isNaN(this.minimum)) && 0 < e && (e = 0), this.includeZero && (null === this.maximum || isNaN(this.maximum)) && 0 > f && (f = 0)), Math.abs(this.getApparentDifference(e, f, null, !0)), "axisX" === this.type && c) {
                        ...
                        if (null === this.maximum || isNaN(this.maximum)) this.maximum = f + g / 2, this.maximum = Math.max(this.maximum, null === this.sessionVariables.viewportMaximum || isNaN(this.sessionVariables.viewportMaximum) ? -Infinity : this.sessionVariables.viewportMaximum)
                    } else this.intervalType = this.valueType = "number", null === this.minimum && (this.minimum = "axisX" === this.type ? e - g / 2 : Math.floor(e / this.interval) * this.interval, this.minimum = Math.min(this.minimum, null === this.sessionVariables.viewportMinimum || isNaN(this.sessionVariables.viewportMinimum) ? Infinity : this.sessionVariables.viewportMinimum)), null === this.maximum && (this.maximum = "axisX" === this.type ? f + g / 2 : Math.ceil(f / this.interval) * this.interval, this.maximum = Math.max(this.maximum, null === this.sessionVariables.viewportMaximum || isNaN(this.sessionVariables.viewportMaximum) ? -Infinity : this.sessionVariables.viewportMaximum)), 0 === this.maximum && 0 === this.minimum && (0 === this.options.minimum ? this.maximum += 10 : 0 === this.options.maximum && (this.minimum -= 10));
        ...
        T.prototype.render = function(a) {
            if (0 !== this.spacing || 0 !== this.options.lineThickness && ("undefined" !== typeof this.options.lineThickness || 0 !== this.parent.lineThickness)) {
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    if (b = 1 === n % 2 ? (b.x << 0) + 0.5 : b.x << 0, g = 1 === n % 2 ? (e.x << 0) + 0.5 : e.x << 0, "top" === this.scaleBreaks.parent._position ? (e = this.chart.plotArea.y1, l = this.chart.plotArea.y2 + n / 2 + 0.5 << 0) : (e = this.chart.plotArea.y2, l = this.chart.plotArea.y1 - n / 2 + 0.5 << 0, a *= -1), this.bounds = {
                            x1: b - n / 2,
                            y1: e,
                            x2: g + n / 2,
                            y2: l
                        }, this.ctx.moveTo(b, e), "straight" === this.type || "top" === this.scaleBreaks.parent._position && 0 >= a || "bottom" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(b, l), this.ctx.lineTo(g, l), this.ctx.lineTo(g, e);
                    ...
                    if (e = 1 === n % 2 ? (e.y << 0) + 0.5 : e.y << 0, l = 1 === n % 2 ? (b.y << 0) + 0.5 : b.y << 0, "left" === this.scaleBreaks.parent._position ? (b = this.chart.plotArea.x1, g = this.chart.plotArea.x2 + n / 2 + 0.5 << 0) : (b = this.chart.plotArea.x2, g = this.chart.plotArea.x1 - n / 2 + 0.5 << 0, a *= -1), this.bounds = {
                            x1: b,
                            y1: e - n / 2,
                            x2: g,
                            y2: l + n / 2
                        }, this.ctx.moveTo(b, e), "straight" === this.type || "left" === this.scaleBreaks.parent._position && 0 >= a || "right" === this.scaleBreaks.parent._position && 0 <= a) this.ctx.lineTo(g, e), this.ctx.lineTo(g, l), this.ctx.lineTo(b, l);
                    else if ("wavy" === this.type) {
                    s = b;
                    k = e;
                    f = 0.5;
        ...
        M.prototype.render = function() {
            ...
            if (0 < d) {
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position) e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0, g = this.chart.plotArea.y1, l = this.chart.plotArea.y2, this.bounds = {
                    x1: e - d / 2,
                    y1: g,
                    x2: f + d / 2,
                    y2: l
        ...
        $.prototype.render = function(a, d, c) {
            ...
            if (!this.valueFormatString)
                if ("dateTime" === this.parent.valueType) this.valueFormatString = this.parent.valueFormatString;
                    ...
                    var n = 0,
                        n = "xySwapped" === this.chart.plotInfo.axisPlacement ? 50 < this.parent.range ? 0 : 500 < this.chart.width && 25 > this.parent.range ? 2 : Math.floor(Math.abs(Math.log(this.parent.range) / Math.LN10)) + (5 > this.parent.range ? 2 : 10 > this.parent.range ? 1 : 0) : 50 < this.parent.range ? 0 : Math.floor(Math.abs(Math.log(this.parent.range) / Math.LN10)) + (5 > this.parent.range ? 2 : 10 > this.parent.range ? 1 : 0);
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if (this.parent.labels)
                            ...
                            crosshair: this.options,
                            value: x.dataPoint.x
                        }) : s(this.options.label) ? Aa(x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: x.dataPoint.x
                        }) : s(this.options.label) ? ea(x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo) : this.label);
                    ...
                    if ("rangeColumn" === this.parent.dataSeries[y].type || "rangeArea" === this.parent.dataSeries[y].type || "error" === this.parent.dataSeries[y].type || "rangeSplineArea" === this.parent.dataSeries[y].type || "candlestick" === this.parent.dataSeries[y].type || "ohlc" === this.parent.dataSeries[y].type || "boxAndWhisker" === this.parent.dataSeries[y].type) {
                        ...
                        this.value = C
                    } else "waterfall" === this.parent.dataSeries[y].type ? (w = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataSeries.dataPointEOs[x.index].cumulativeSum) << 0, k.text = this.labelFormatter ? this.labelFormatter({
                        chart: this.chart,
                        axis: this.parent.options,
                        crosshair: this.options,
                        value: x.dataSeries.dataPointEOs[x.index].cumulativeSum
                    }) : s(this.options.label) ? ea(c ? c : x.dataSeries.dataPointEOs[x.index].cumulativeSum, this.valueFormatString, this.chart._cultureInfo) : this.label, this.value = x.dataSeries.dataPointEOs[x.index].cumulativeSum) : (w = 1 === q.lineWidth % 2 ? (s(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5 : s(a) ? d : this.parent.convertValueToPixel(x.dataPoint.y) << 0, k.text = this.labelFormatter ? this.labelFormatter({
                        chart: this.chart,
                        axis: this.parent.options,
                        crosshair: this.options,
                ...
                if ("left" === this.parent._position || "right" === this.parent._position) "left" === this.parent._position && k.x < this.chart.bounds.x1 && (k.x = this.chart.bounds.x1), "right" === this.parent._position && k.x + k.measureText().width > this.chart.bounds.x2 && (k.x = this.chart.bounds.x2 - k.measureText().width), g >= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMinimum : this.parent.viewportMaximum) && f <= this.parent.convertValueToPixel(this.parent.reversed ? this.parent.viewportMaximum : this.parent.viewportMinimum) && (0 < n && (q.moveTo(b, f), q.lineTo(e, g), q.stroke(), this._hidden = !1), q.restore(), !s(k.text) && ("number" === typeof k.text.valueOf() || 0 < k.text.length) && k.render(!0))
            } else {
                if ("bottom" === this.parent._position || "top" === this.parent._position) b = e = l = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0, f = this.chart.plotArea.y1, g = this.chart.plotArea.y2, this.bounds = {
                    x1: b - n / 2,
                    y1: f,
                    x2: e + n / 2,
                    y2: g
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement)
                    if ("left" === this.parent._position || "right" === this.parent._position) {
                        ...
                        }) : s(this.options.label) ? Aa(c ? c : this.parent.convertPixelToValue(d), this.valueFormatString, this.chart._cultureInfo) : this.label : "number" === this.parent.valueType && (k.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
                            value: c ? c : this.parent.convertPixelToValue(d)
            ...
            if (!this.chart.disableToolTip) {
                ...
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                        ...
                        if (this.chart.axisX)
                            for (var v = 0; v < this.chart.axisX.length; v++) {
                                for (var g = this.chart.axisX[v].convertPixelToValue({
                                        y: d
                                    }), k = null, b = 0; b < this.chart.axisX[v].dataSeries.length; b++)(k = this.chart.axisX[v].dataSeries[b].getDataPointAtX(g, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX[v].dataSeries[b], null !== k.dataPoint.y && l.push(k));
                                k = null
                            }
                        if (this.chart.axisX2)
                            for (v = 0; v < this.chart.axisX2.length; v++) {
                                ...
                                k = null;
                                for (b = 0; b < this.chart.axisX2[v].dataSeries.length; b++)(k = this.chart.axisX2[v].dataSeries[b].getDataPointAtX(g, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[v].dataSeries[b], null !== k.dataPoint.y && l.push(k));
                                k = null
                            }
                    } else {
                        l = [];
                        ...
                        if (this.chart.axisX2)
                            for (v = 0; v < this.chart.axisX2.length; v++)
                                for (g = this.chart.axisX2[v].convertPixelToValue({
                                        x: a
                                    }), k = null, b = 0; b < this.chart.axisX2[v].dataSeries.length; b++)(k = this.chart.axisX2[v].dataSeries[b].getDataPointAtX(g, c)) && 0 <= k.index && (k.dataSeries = this.chart.axisX2[v].dataSeries[b], null !== k.dataPoint.y && l.push(k))
                    }
                    ...
                    if (0 <= this.currentSeriesIndex) {
                        ...
                        k = {};
                        if (0 <= this.currentDataPointIndex) b = e.dataPoints[this.currentDataPointIndex], k.dataSeries = e, k.dataPoint = b, k.index = this.currentDataPointIndex, k.distance = Math.abs(b.x - g), "waterfall" === e.type && (k.cumulativeSumYStartValue = e.dataPointEOs[this.currentDataPointIndex].cumulativeSumYStartValue, k.cumulativeSum = e.dataPointEOs[this.currentDataPointIndex].cumulativeSum);
                        else {
        ...
        X.prototype.showAtX = function(a, d) {
            ...
            if (0 < f.length) {
                for (g = 0; g < f.length; g++)
                    if (b = f[g], b.dataPoint.x < b.dataSeries.axisX.viewportMinimum || b.dataPoint.x > b.dataSeries.axisX.viewportMaximum || b.dataPoint.y < b.dataSeries.axisY.viewportMinimum || b.dataPoint.y > b.dataSeries.axisY.viewportMaximum) e = !0;
                    else {
                        e = !1;
                        break
        ...
        var K = {
            ...
            V = {
                drawMarker: function(a, d, c, b, e, f, g, l) {
                    if (c) {
                        var s = 1;
